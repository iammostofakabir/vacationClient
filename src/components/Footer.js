        ...
        <Container>
          <Row className="pt-3 text-center">
            <Col xs={12} md={3}>
              ...
              />
              <h5 style={{fontFamily:"gabriola", fontSize:"2rem", color:"white", fontWeight:"bold"}}>Scratch Vacation</h5>
            ...
            <Col xs={12} md={3}>
              <ul>
                ...
                <li><Link to="/products" className="text-white">Explore</Link></li>
            ...
            <Col xs={12} md={3}>
              <div className="text-center">
                ...
                <button className="border  rounded-pill fs-4 px-2 app-button text-black"><i class="fab fa-google-play me-3"></i>Playstore</button>
                <h4></h4>
                <button className="border rounded-pill fs-4 px-2 bg-black text-black app-button"><i class="fab fa-app-store me-3"></i>Appstore</button>
              </div>
            </Col>
            <Col xs={12} md={3}>
          ...
          <p className="text-white text-center py-3 m-0">Copyright &copy; Restricted || Scratch Vacation {new Date().getFullYear()}.</p>
        </Container>
      </div>
    </>
  );
